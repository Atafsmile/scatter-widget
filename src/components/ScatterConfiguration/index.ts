...
import { ScatterConfiguration } from './ScatterConfiguration';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(ScatterConfiguration, props));
}
...
(window as any).ReactWidgets['ScatterConfiguration'] = { mount, update, unmount };
